...
public class DlgHexagon extends JDialog {
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						try {
							...
							hexagon = new HexagonAdapter(new Point(newX, newY), newRadius, false, borderColor, innerColor);
							setVisible(false);
	...
	public void setHexagon(HexagonAdapter hexagon) {
		txtCenterX.setText("" + hexagon.getX());
		txtCenterY.setText("" + hexagon.getY());
		txtRadius.setText("" + hexagon.getRadius());
		borderColor = hexagon.getColor();
